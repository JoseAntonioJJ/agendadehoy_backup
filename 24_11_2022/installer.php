...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20221115_agendadehoy_742fc530662ae8612164_20221124104854_archive.zip';
        const ARCHIVE_SIZE       = '29509442';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '742fc53-24104854';
        const SECONDARY_PACKAGE_HASH = '1e8e9ec-24104854';
        const VERSION            = '1.5.1';
