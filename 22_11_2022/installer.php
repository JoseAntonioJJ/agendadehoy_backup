...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20221115_agendadehoy_0568956a3fe1df5f3377_20221122122410_archive.zip';
        const ARCHIVE_SIZE       = '26980217';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '0568956-22122410';
        const SECONDARY_PACKAGE_HASH = 'be54185-22122410';
        const VERSION            = '1.5.1';
