...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20221115_agendadehoy_f0f60a0f094c027d9853_20221115111222_archive.zip';
        const ARCHIVE_SIZE       = '23895053';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = 'f0f60a0-15111222';
        const SECONDARY_PACKAGE_HASH = '936c0ff-15111222';
        const VERSION            = '1.5.0';
