...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20221115_agendadehoy_d5376551360602532460_20221116121547_archive.zip';
        const ARCHIVE_SIZE       = '23899680';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = 'd537655-16121547';
        const SECONDARY_PACKAGE_HASH = '3903d3c-16121547';
        const VERSION            = '1.5.0';
